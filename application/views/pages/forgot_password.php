            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form method="post" autocomplete="off" class="user" >
                    ...
                    <div class="form-group mt-3">
                      <button type="submit" id="login" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">SUBMIT</button>
                    </div>
                    <hr>
                  </form>
                  <hr>
